...
This has been tested against Keycloak 26.5.5 using the official container image. It may work against other versions of Keycloak and Java as well but is untested.
